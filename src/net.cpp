...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "magnum " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"45.55.250.118", "45.55.250.118"},
	{"104.236.83.94", "104.236.83.94"},
	{"seed3.cryptolife.net", "seed3.cryptolife.net"},
	{"electrum5.cryptolife.net", "electrum5.cryptolife.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. magnum is probably already running."), addrBind.ToString().c_str());
        else
